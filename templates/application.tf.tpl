...
//Look up all the secrets from the infra structure project
...
//Create cloudbuild trigger to create cloud deploy resources
resource "google_cloudbuild_trigger" "YOUR_APPLICATION_NAME_cloudbuild_trigger" {
  name     = "deploy-app"
  project = module.YOUR_APP_PROJECT_NAME.project_id
